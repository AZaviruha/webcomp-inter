define(function () {
	 ...
	 */
	function handle(eventName, selector, callback, domless) {
        ...
        var descriptor = eventName + ': ' + selector;
        var list = (domless)? directList : domList;
        if (!list[descriptor]) {
            list[descriptor] = [];
        }
	 ...
	 *                               removed
	 */
	function removeHandle(eventName, selector, callback) {
